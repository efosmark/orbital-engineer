...
def _extract_pci_bdf(value:Any) -> str|None:
...
def get_device_pci_bdf(device:Any) -> str|None:
    ...
    for name in dir(cl.device_info):
        ...
        try:
            ...
            continue
        bdf = _extract_pci_bdf(value)
        if bdf is not None:
            return bdf
    return None

def map_pci_bdf_to_drm_card(pci_bdf:str|None) -> int|None:
