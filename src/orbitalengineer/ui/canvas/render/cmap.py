...
class MomentumColorizedRenderer(renderer.Renderer):
    ...
    def draw(self, cr:cairo.Context, width:int, height:int):
        ...
        for b in self.orbital:
            ...
            self.view.props.particle_colors[b.idx] = self.colors[b.idx]